...
def confusionMatrixNumToPct(confusionMatrix):
    ...
    fnRate = confusionMatrix[2]/(confusionMatrix[1]+confusionMatrix[3]) # target called noise/total noise
    tnRate = confusionMatrix[3]/(confusionMatrix[1]+confusionMatrix[3]) # noise called noise/total noise
