...
"""
def train_siamese_hourglass_nn(trainImages, trainMasks, testImages, testMasks, \
...
if __name__ == "__main__":  
    ...
    heatmaps = train_siamese_hourglass_nn(x_train, y_train_pmMask, x_test, y_test_pmMask, 
