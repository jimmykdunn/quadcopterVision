...
def importRoboticsLabData(quickTest=False):
    ...
    x_set1, y_set1, id_set1 = vu.pull_aug_sequence(
        os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab1_96x72_mirror_noHand","augImage_"),
        os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab1_96x72_mirror_noHand","augMask_"))
    id_set1_plus = [id+"_01" for id in id_set1]
    x_set2, y_set2, id_set2 = vu.pull_aug_sequence(
        os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab2_96x72_mirror_noHand","augImage_"),
        os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab2_96x72_mirror_noHand","augMask_"))
    ...
    if not quickTest:
        x_set3, y_set3, id_set3 = vu.pull_aug_sequence(
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab3_96x72_mirror_noHand","augImage_"),
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab3_96x72_mirror_noHand","augMask_"))
        id_set3_plus = [id+"_03" for id in id_set3]
        x_set4, y_set4, id_set4 = vu.pull_aug_sequence(
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab4_96x72_mirror_noHand","augImage_"),
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab4_96x72_mirror_noHand","augMask_"))
        id_set4_plus = [id+"_04" for id in id_set4]
        x_set5, y_set5, id_set5 = vu.pull_aug_sequence(
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab1_96x72_baby_mirror_noHand","augImage_"),
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab1_96x72_baby_mirror_noHand","augMask_"))
        id_set5_plus = [id+"_05" for id in id_set5]
        x_set6, y_set6, id_set6 = vu.pull_aug_sequence(
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab2_96x72_baby_mirror_noHand","augImage_"),
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab2_96x72_baby_mirror_noHand","augMask_"))
        id_set6_plus = [id+"_06" for id in id_set6]
        x_set7, y_set7, id_set7 = vu.pull_aug_sequence(
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab3_96x72_baby_mirror_noHand","augImage_"),
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab3_96x72_baby_mirror_noHand","augMask_"))
        id_set7_plus = [id+"_07" for id in id_set7]
        x_set8, y_set8, id_set8 = vu.pull_aug_sequence(
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab4_96x72_baby_mirror_noHand","augImage_"),
            os.path.join("augmentedContinuousSequences","defaultGreenscreenVideo_over_roboticsLab4_96x72_baby_mirror_noHand","augMask_"))
